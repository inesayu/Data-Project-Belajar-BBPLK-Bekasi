      ...
      <div class="col-md-8">
        ...
        <?php
    			...
    			$password=$_POST['password'];
    		 	/*if(($username=="admin") AND ($password=="ines")){
    				echo "<h4>Anda Berhasil Login</h4>";
    		 	}else{
    				echo "<h4>Anda Gagal Login</h4>";
    			}*/
    			...
    			if($username=="admin"){
    				if($password=="ines"){
    					...
    					echo "<h4>Password Anda Salah</h4>";
    				}
    		 	}else{
    				echo "<h4>Username Anda Salah</h4>";
    			}
    		?>
    		<br>
    		<button type="" class="btn btn-outline-secondary form-control"><a href="form_login.php">Kembali</a></button>
        <hr class="d-md-none">
      </div>
